...
##gmidi
##____________
##Pianoroll Multi-track module slightly modified adapted from Hao-Wen Dong available in https://github.com/salu133445/pypianoroll
##____________
...
from .. import pretty_midi as pretty_midi
from .track import Track
from .plot import plot_multitrack
...
class Multitrack(object):
    ...
    def get_stacked_pianoroll(self):
        return (self.get_stacked_pianorolls())
