...
##gmidi
##____________
##Pretty midi module little adapted from Colin Raffel and Daniel P. W. Ellis available in https://github.com/craffel/pretty-midi
##____________
...
class PrettyMIDI(object):
    ...
    def __init__(self, midi_file=None, resolution=None, initial_tempo=120.):
        ...
        if midi_file is not None:
            ...
            if resolution is not None:
                midi_data = change_res_fil(midi_data,resolution)
